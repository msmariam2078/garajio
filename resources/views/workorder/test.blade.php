...
function initAutocomplete_map() {
    ...
    var locationInput = document.getElementById('service_location');
    ...
    var c_val = country_arr.filter(str => str.includes($("#country").val() + "="));
    var c_val1 = c_val[0].split("=")[1];

    var initialLocation = {
        lat: parseFloat(c_val1.split(",")[0]),
        lng: parseFloat(c_val1.split(",")[1])
    };
    ...
    autocomplete.addListener('place_changed', function() {
        ...
        if (place.address_components) {
            for (var i = 0; i < place.address_components.length; i++) {
                ...
                setAddressField(addressType, place.address_components[i]);
            }
        }
    ...
    // Listener for marker drag event
        ...
        geocoder.geocode({
            ...
            if (status === 'OK' && results[0]) {
                ...
                for (var i = 0; i < addressComponents.length; i++) {
                    ...
                    setAddressField(addressType, addressComponents[i]);
                }
            }
        });
    });
    ...
    function setAddressField(addressType, addressComponent) {
        if (addressType === 'locality') {
            document.getElementById('service_city1').value = addressComponent.long_name;
        } else if (addressType === 'administrative_area_level_1') {
            document.getElementById('service_state1').value = addressComponent.short_name;
        } else if (addressType === 'country') {
            document.getElementById('service_country1').value = addressComponent.long_name;
        } else if (addressType === 'postal_code') {
            document.getElementById('service_zip_code1').value = addressComponent.long_name;
        }
    }
}
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBO1Dw9T3wDRjN2RyrGLE2XTG86x46cIUc&libraries=places" defer></script>
<!--Internal  Notify js -->
