...
<div class="modal-body px-0 123">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6 d-none" id="gst-field">
            ...
            {{ Form::text('gst_number', null, ['class' => 'form-control', 'placeholder' => 'Enter GST / VAT Number']) }}
        </div>
        <div class="form-group col-md-12">
        ...
        <div class="form-group col-md-8">
            <!-- Phone Number Input -->
            {{ Form::text('phone_number', null, ['class' => 'form-control numberonly', 'id' => 'phone_number', 'required' => 'required']) }}
...
<div class="row billing_info d-none">
    ...
    <input type="hidden" value="1" name="frombooking"/>
</div>
</div>
