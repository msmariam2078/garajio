...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card">
           ...
           <input type="hidden" id="workorder_id" value="{{ $workOrder->id }}">
                    <input type="hidden" id="source" value="tech">
                    <div class="col-md-4">
...
function submitPayment() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            // {
        url=window.location.href = '/workorder/details/'+response.workorderId;
