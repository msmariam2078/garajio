<div class="modal-body">
    <form method="POST" action="{{ route('booking.postcancelquotation') }}" accept-charset="UTF-8" enctype="multipart/form-data">
        @csrf
       
        <input name="quotationid" value="{{$quotationid}}" type="hidden"/>
        ...
        <div class="row mb-5">
            <div class="form-group col-md-12">
                <label for="cancellation_note" class="form-label">Cancellation Reason</label>
                <textarea 
                    class="form-control" 
