  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary"  data-dismiss="modal" id="confirmScrap">Confirm</button>
      </div>
    </div>
  </div>
</div>
                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <p class="mb-0">
                            Address:P.O.Box Nabra At | Almasani' | Riyadh
                            </p>
                            <p class="mb-0">
                            Tel: +966 144 333 458
                            </p>
                            <p class="mb-0">
                             Email:info@deltaturfcare.com
                            </p>
                            <br>
                                ...
                                @foreach ($quotations as $quotation)
                                                @foreach ($quotation as $key => $item)
                                                    <tr>
                                                        ...
                                                        <td>{{ $item->gstprice }}</td>
                                                        <td>{{ number_format($item->linetotal,3) }}</td>
                                                       
                                                        <td>{{ $item->taxpercentage }}</td>
                                                        <td>{{ number_format($item->taxamount , 3);}}</td>
                        ...
                        <table class="table">
                                <tbody id="abc">
                                    ...
                                    <tr>
                                        <td>Sub total </td>
                                        <td> -</td>
                                        <td class="text-right">{{number_format($subtotal,3)}} AED </td>
                                    </tr>
                                    <tr>
                                        <td>Tax </td>
                                        <td> -</td>
                                        <td class="text-right">{{number_format($tax,3)}} AED</td>
                                    </tr>
                                    <tr>
                                        <td>Discount</td>
                                        <td> -</td>
                                        <td class="text-right">{{number_format($discount,3)}} AED</td>
                                    </tr>
                                    <tr>
                                        <td>Total Due </td>
                                        <td class="px-3"> -</td>
                                        <td class="text-right">{{ number_format($totalamount,3)}} AED </td>
                    ...
                    <div class="btn-list mt-4 d-flex justify-content-end">
                        ...
                        <a type="button" href="{{ url('transferpaymentinvoice/' . $workOrder->id) }}" class="btn btn-warning mx-2 d-none" id="paynow">Pay Now</a>
                      
                       
                        <a type="button" class="btn btn-secondary" id="" href="{{route('workorder.edit',$workOrder->id)}}">Cancel</a>
