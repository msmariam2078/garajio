...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body ">
				<form method="POST" action="{{ route('bookingEdit') }}" accept-charset="UTF-8" enctype="multipart/form-data">
					@csrf
					<div class="row">
						<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-3">
							<label for="reference">Booking ID</label>
							<input type="text" class="form-control" name="reference" id="reference" placeholder="Enter reference number"
								value="{{ $bookingReference }}" readonly>
							<input type="hidden" name="booking_id" value="{{$bookings->id}}" id="booking_id" />
							<input type="hidden" name="workorderid" value="{{$bookings->workorderid}}">
						</div>

						<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-3">
							<label for="bookingDate">Booking Date</label>
							<input type="date" class="form-control" name="bookingDate" id="bookingDate" value="{{$bookings->booking_date}}"
								readonly>
						</div>

						<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-3">
							<label for="scheduled_time" class="form-label">Booking Time</label>
							<input type="time" class="form-control mt-2" name="bookingTime" value="{{$bookings->booking_time}}"
								name="scheduled_time" id="scheduled_time" placeholder="Enter scheduled Time">
						</div>

						<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-3">
							<label for="requestdate">Request Date</label>
							<input type="date" class="form-control" name="requestdate" id="requestdate" value="{{$bookings->requested_date}}"
								required>
						</div>

						<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-3">
							<label for="requesttime">Request Time</label>
							<input type="time" class="form-control" name="requesttime" id="requesttime" value="{{$bookings->requested_time}}"
								required>
						</div>

						<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-3">
							<label for="dueDate">Due Date</label>
							<input type="date" class="form-control" name="due_date" id="dueDate" value="{{$bookings->due_date}}" readonly>
						</div>

						<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-3">
							<label for="service_group" class="form-label">Service Group</label>
							<select class="form-control select2 mt-2" name="service_group[]" multiple="multiple"
								id="service_group">
						...
						@php
						$selectedSkills = is_null($bookings->skill_group) ? [] : json_decode($bookings->skill_group, true);
						@endphp

						<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-3">
							<label for="skill_group" class="form-label">Skill Group</label>
							<select class="form-control select2 mt-2" name="skill_group[]" multiple="multiple"
								id="skill_group">
						...
						<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-3">
							...
							{{ Form::select('country', $country, $country_s, ['class' => 'form-control basic-select', 'id' => 'country', 'disabled']) }}
						</div>

						<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-3">
							<label for="city" class="form-label">City</label>
							<input type="text" class="form-control mt-2" name="city" id="city" placeholder="Enter City Name"
								value="{{@$bookings->city}}" readonly>
						</div>
						...
						<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-3">
							...
							<input type="text" id="service_location" name="service_location" class="form-control mt-2"
								placeholder="Service Address" value="{{@$bookings->service_location}}" readonly
								style="background-color: #e9ecef;">
							<a class="float-end small float-end badge bg-primary text-light" href="#" data-bs-toggle="modal"
						...
						<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-3">
							...
							<input type="text" class="form-control" value="{{$bookings->landmark}}" name="landmark" id="landmark">
						</div>

						<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-3">
							<label for="description">Description</label>
							<textarea class="form-control" name="description" id="description" rows="2"
								placeholder="Enter description">{{$bookings->description}}</textarea>
						</div>
						...
						<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-3">
							...
							<select class="form-control" name="status" readonly>
								...
								<option value="Completed" {{ $bookings->status == 'Completed' ? 'selected' : '' }}>Completed
								</option>
								<option value="Quote" {{ $bookings->status == 'Quotation' ? 'selected' : '' }}>Quotation
								</option>
								<option value="Cancelled" {{ $bookings->status == 'Cancelled' ? 'selected' : '' }}>Cancelled
								</option>
							</select>
						</div>

						<div class="col-4 mt-1">
							<button class="btn btn-primary mt-4 btn-block" id="bookingDetailsEdit">Update booking details</button>
						</div>
					</div>
				</form>
            </div>
            ...
            <div class="card-body ">
                <div class="row">
						...
						<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-3">
							...
							<input type="text" class="form-control" name="" id="requestdate" value="{{$inspection->template6?->code}}"
								readonly>
						</div>
                         <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-3">
...
@endif
@if(isset($quotations) && $quotations->every(function($quotationItems) {
return $quotationItems->every(function($item) {
                ...
                <div style="float: right; width: 35%; margin-top: 20px;">
                    ...
                    <div class="btn-list mt-4">
                        <div lass="justify-content-center">
                            <a class="btn btn-primary me-2 text-white" id="submitBookingQuotation"
                                onclick="submitBookingQuotation()">
                                Create Quotation
                            </a>
                        </div>
                    </div>
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="card-body">
                <div>
                    <h6 class="card-title mb-1">Quotations</h6>
                </div>
                <div aria-multiselectable="true" class="accordion" id="accordion" role="tablist">
                    @foreach ($quotations as $quotationId => $quotationItems)
                    @php
                    $status = $quotationItems->first()->status;
                    @endphp

                    <div class="card mb-0">
                        <div class="card-header" id="heading{{ $quotationId }}" role="tab">
                            <a aria-controls="collapse{{ $quotationId }}" aria-expanded="false" data-toggle="collapse"
                                href="#collapse{{ $quotationId }}">
                             @if ($status !== 'Started')
                                Quotation ID: {{ $quotationId }} - Status: {{ ucfirst($status) }}
                            @endif
                            </a>
                        </div>
                        <div aria-labelledby="heading{{ $quotationId }}" class="collapse show" data-parent="#accordion"
                            id="collapse{{ $quotationId }}" role="tabpanel">
                            <div class="card-body mt-4 mb-5" style="background-color:white; margin-bottom:-15px;">
                                <div class="d-flex justify-content-end mt-5">
                                 
                                    <!-- <button type="button" class="btn btn-outline-danger me-2 customModal"
                                        data-url="{{ route('quotation.cancel',[ $quotationId ,'quote'])}}">
                                        <i class="ri-close-line"></i> Cancel
                                    </button>&nbsp;
                                    <a href="{{ route('booking.generatequotation', $quotationId) }}"
                                        class="btn btn-outline-primary me-2">
                                        <i class="ri-share-line"></i> Share
                                    </a>&nbsp;
                                    <a href="{{ route('quotation.accept', $quotationId) }}"
                                    ...
                                    <a href="{{ route('quotation.confirm', $quotationId) }}"
                                        class="btn btn-outline-success">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table text-nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{ \Carbon\Carbon::parse($item->send_date)->format('Y-m-d') }}</td>
                ...
                <div class="btn-list mt-4 d-flex justify-content-end">
                    <a class="btn btn-primary me-2" href="{{ route('workorder.edit', $bookings->workorderid) }}">
                        WorkOrder
                    </a>&nbsp;
                    <button type="button" class="btn btn-primary customModal"
                        data-url="{{ route('booking.cancel', $bookings->id) }}">
                        Cancel
                    </button>
                </div>
            </div>
...
<input type="hidden" id="selectedVehicleId" name="vehicle_id" value="{{$vehicles->id}}" />
   ...
   async function fetchAndShowFirstProduct() {
            ...
            try {
                ...
                const response = await fetch(
                    `/getquotation/workorder?status=${status}&booking_id=${bookingId}`
                );
    ...
    document.querySelectorAll('.item-type').forEach(function(select) {
        select.addEventListener('change', async function() {
            ...
            if (firstProduct) {
                ...
                items[index].discount_percentage = parseFloat(firstProduct.discount_percentage) ||
                    0;
...
function handleDoubleClickEdit() {
    ...
    document.querySelectorAll('.item_no-cell').forEach(function(cell) {
        cell.addEventListener('click', function() {
            const index = parseInt(this.getAttribute('data-index'));
            const currentitem_no = items[index].item_no;

            const input = document.createElement('input');
            input.type = 'text';
            input.value = currentitem_no;
            ...
            input.addEventListener('blur', function() {
                const newitem_no = this.value.trim();
                items[index].item_no = newitem_no;
                renderTable();
            });
        });
    });
    ...
    document.querySelectorAll('.unit-price-cell').forEach(function(cell) {
        cell.addEventListener('click', function() {
            ...
            input.addEventListener('blur', function() {
                ...
                const taxAmount = items[index].lineTotal * (items[index].tax_percentage / 100);
...
function updateSummary() {
    ...
    items.forEach(item => {
        ...
        discountAmount += ((parseFloat(item.unitPrice) || 0) * (parseInt(item.quantity) || 1)) * (parseFloat(
...
$(document).ready(function() {
    ...
    function collectFormData() {
        let formData = {
            ...
            service_group: $('select[name="service_group[]"]')
                .val(),

            skill_group: $('select[name="skill_group[]"]')
                .val(), // This will collect all selected values
            city: $('#city').val(),
            country: $('#country').val(),
    ...
    function collectProductDetails() {
        ...
        $('#productTableBody tr').each(function() {
            let product = {
                ...
                taxpercentage: $(this).find('td:eq(11)').text(),
                taxamount: $(this).find('td:eq(12)').text(),
                totalamount: $(this).find('td:eq(13)').text(),
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        loadComments(); // Reload the comments after a successful submission
                    }
                },
                error: function(xhr) {
                    $("#error-message").text(xhr.responseJSON.error);
...
function submitBookingQuotation() {
    let booking_id = getBookingId();
    let customer_id = getCustomerId();
    let products = collectProductDetails();

    $.ajax({
        url: '{{ route('bookingquotation.store') }}',
        method: 'POST',
        data: {
            _token: '{{ csrf_token() }}',
        ...
        error: function(xhr, status, error) {
            ...
            alert('There was an error submitting the booking quotation.');
        }
    });
}
</script>
