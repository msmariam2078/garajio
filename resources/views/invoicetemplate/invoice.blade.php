...
<body>
    <div class="container">
		...
		<header style="text-align: center !important; margin-bottom:40px">
        ...
        <table class="quotation-table">
            ...
            <tbody>
                ...
                <tr class="item">
                    ...
                    <td>{{ $product->qty }}</td>
                    <td>AED {{ number_format($product->unit_price , 2) }}</td>
                    ...
                    <td>{{ number_format($product->totalamount , 2) }}</td>
                     ...
                     @php
                                                   ...
                                                   $subtotal= $subtotal +$product->linetotal ;
     ...
     <!-- Total Section -->
            ...
            <table class="invoice-table" style="width:100%;float:right">
                ...
                <tr>
                    ...
                    <td class="value"><strong>AED {{$totalamount}}</strong></td>
                </tr>
            </table>
           </section>
        ...
        <!-- Total Section -->
        <!-- <section class="total-section  d-nome">
            <p><strong>Subtotal Excl. VAT:</strong> {{ $subtotal }}</p>
        ...
        <footer class="footer">
            ...
            <p clas="h3">Prepared By: {{\Auth::user()->full_name}}</p>
        </footer>
