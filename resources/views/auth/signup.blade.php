                                    ...
                                    <form action="{{ route('register') }}" method='post'>
                                        ...
                                        <div class="form-group">
                                            <label>Firstname &amp; Lastname</label> <input class="form-control"
                                                placeholder="Enter your firstname and lastname" type="text" name='name'>
                                        </div>
                                        @error('name')
                                        ...
                                        <div class="form-group">
                                            ...
                                            @enderror
                                            <input class="form-control showhide-password" type="password"
                                            ...
                                            @enderror
                                        </div><button type='submit' class="btn btn-main-primary btn-block">Create
                                            Account</button>
