...
if (!function_exists('settingsKeys')) {
    function settingsKeys()
    {
        return $settingsKeys = [
            ...
            "technician_number_prefix" => "#TAC-000",
            "inquiry_number_prefix"=>"#INQ-000",
            'CURRENCY' => "USD",
            'CURRENCY_SYMBOL' => "$",
            'STRIPE_PAYMENT' => "off",
            'STRIPE_KEY' => "",
...
if (!function_exists('inquiryPrefix')) {
    function inquiryPrefix()
    {
        $settings = settings();
        return $settings["inquiry_number_prefix"];
    }
}
...
if (!function_exists('technicianPrefix')) {
    function technicianPrefix()
    {
        $settings = settings();
        return $settings["technician_number_prefix"];
    }
}
...
if (!function_exists('isOverlap')) {
  function isOverlap($aStart, $aEnd, $bStart, $bEnd)
                                {
                                    return $aStart < $bEnd && $bStart < $aEnd;
                                }
}
if (!function_exists('defaultTechnicianCreate')) {
    function defaultTechnicianCreate($id)
    {
        $clientRoleData =  [
            'name' => 'technician',
            'parent_id' => $id,
        ...
        $systemClientRole = Role::updateOrInsert($clientRoleData);
        $systemClientPermissions = [
